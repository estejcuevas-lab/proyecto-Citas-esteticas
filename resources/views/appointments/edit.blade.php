...
<main class="shell">
    <section class="panel">
        <h1>Editar cita</h1>
        <p>Desde aqui puedes actualizar los datos principales de la reserva mientras avanzamos hacia validaciones mas completas.</p>
        ...
        <form method="POST" action="{{ route('appointments.update', $appointment) }}">
            ...
            <input id="end_time" name="end_time" type="time" value="{{ old('end_time', $appointment->end_time) }}" required>
