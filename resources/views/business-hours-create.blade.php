...
@section('content')
    <section class="surface" style="max-width: 45rem; margin: 0 auto;">
        ...
        <form method="POST" action="{{ route('businesses.hours.store', $business) }}" class="mt-6 field-list">
            @csrf
            ...
            <div class="actions">
                ...
                <a class="btn btn-secondary" href="{{ route('businesses.hours.index', $business) }}">Cancelar</a>
            </div>
        </form>
    </section>
@endsection
